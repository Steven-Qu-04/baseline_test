...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Aggregate two-stage MLP downstream metrics and plot performance evolution.")
...
def main() -> None:
    ...
    ax.set_title("Two-Stage MLP Performance Evolution")
    fig.tight_layout()
