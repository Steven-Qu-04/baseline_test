...
try:
    ...
    from compat.common.registry import registry
    from compat.common.typing import assert_is_instance
    from compat.common.utils import pyg2_data_transform
    from compat.datasets.target_metadata_guesser import guess_property_metadata
    from compat.modules.transforms import DataTransforms
